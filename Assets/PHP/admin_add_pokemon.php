...
$namecheckquery = "SELECT pokemonID FROM players WHERE pokemonID = '$pokemonID'; ";
...
$move_pool_check_query == "SELECT moveID1 FROM move;";
...
$move_pool_check_query2 == "SELECT moveID2 FROM move;";
...
$move_pool_check_query3 == "SELECT moveID3 FROM move;";
$move_pool_check2 = mysqli_query($con, $move_pool_check_query3);
if (mysqli_num_rows($move_pool_check3) == 0) {
    echo "Move ID 3 Doesn't Exist in Move!";
    exit();
}

$move_pool_check_query4 == "SELECT moveID4 FROM move;";
$move_pool_check2 = mysqli_query($con, $move_pool_check_query4);
if (mysqli_num_rows($move_pool_check4) == 0) {
    echo "Move ID 4 Doesn't Exist in Move!";
    exit();
}

$move_pool_check_query5 == "SELECT moveID5 FROM move;";
...
$move_pool_check_query6 == "SELECT moveID6 FROM move;";
