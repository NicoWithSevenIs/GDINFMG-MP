...
public class SampleMons
{
    ...
    public SampleMons()
    {
        ...
        mon = new(1, monData1, ESex.MALE, new Stat(31, 31, 31, 31, 31, 31), new Stat(6, 252, 0, 0, 0, 252), "Jolly", new int[4]{1,2,18,9});
        mon2 = new(1, monData2, ESex.FEMALE, new Stat(31, 31, 31, 31, 31, 31), new Stat(6, 0, 0, 252, 0, 252), "Timid", new int[4] { 1, 2, 18, 9 });
        mon3 = new(1, monData3, ESex.NONE, new Stat(31, 31, 31, 31, 31, 31), new Stat(6, 252, 0, 0, 0, 252), "Adamant", new int[4] { 1, 2, 18, 9 });
